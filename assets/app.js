...
(function () {
  ...
  /* Journey strip: you-are-here across the sessions (6 sessions, one customer master) */
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-no-shared-key.html", "02-comparing-strings.html", "03-fellegi-sunter.html", "04-blocking.html", "05-judging-it.html", "06-master-data.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:entity-resolution";
  ...
  var FNS = {
    ...
    contrast: function (s) {
      ...
      if (hx.length < 2) return { error: "Give me two hex colours, for example  #FFFFFF #4D7C0F" };
      function lum(h) {
        h = h.replace("#", "");
