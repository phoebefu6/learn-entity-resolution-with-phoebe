/* mindmap.js - reusable knowledge-map layer for the learn-X-with-phoebe courses.
   ...
   window.MINDMAP_DATA = {
     ...
     centerColor: "#365314",
     sessions: [
       { label:"Frame & charter", href:"courses/01-...html", color:"#4D7C0F",
...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#4D7C0F");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#365314");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#D9F99D");   // concept border
  var C_TINT   = theme("--indigo-50", "#F7FEE7");     // concept fill
  var C_INK    = theme("--ink", "#1A2010");           // concept text
  var C_FAINT  = theme("--faint", "#CBD5C0");         // twig edges
